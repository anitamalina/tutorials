---
title: UI5 Tutorials
permalink: walkthrough/build/09/README.html
---
...
**Next:** [Step 10: Manifest (Descriptor for Applications)](../10/index.html "All application-specific configuration settings will now further be put into the manifest. This clearly separates the application coding from the configuration settings and makes our app even more flexible.")

**Previous:** [Step 8: Translatable Texts](../08/index.html "In this step we move the texts of our UI to a separate resource file.")

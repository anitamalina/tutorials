---
title: UI5 Tutorials
permalink: walkthrough/build/26/README.html
---
...
**Next:** [Step 27: Unit Test with QUnit](../27/index.html "Now that we have a test folder in the app, we can start to increase our test coverage.")

**Previous:** [Step 25: Remote OData Service](../25/index.html "So far we have worked with local JSON data, but now we will access a real OData service to visualize remote data.")

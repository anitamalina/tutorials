---
title: UI5 Tutorials
permalink: walkthrough/build/02/README.html
---
...
**Next:** [Step 3: Controls](../03/index.html "Now it's time to build our first little UI by replacing the Hello World text in the HTML body by the OpenUI5 control sap.m.Text. In the beginning, we will use the TypeScript control API to set up the UI, the control instance is then placed into the HTML body‚")

**Previous:** [Step 1: Hello World!](../01/index.html "As you know OpenUI5 is all about HTML5. Let's get started with building a first Hello World with only HTML. In addition we will initialize the UI5 CLI, so we can benefit from it from the beginning.")

---
title: UI5 Tutorials
permalink: walkthrough/build/07/README.html
---
...
**Next:** [Step 8: Translatable Texts](../08/index.html "In this step we move the texts of our UI to a separate resource file.")

**Previous:** [Step 6: Modules](../06/index.html "In OpenUI5, resources are often referred to as modules. In this step, we replace the alert from the last exercise with a proper Message Toast from the `sap.m` library.")

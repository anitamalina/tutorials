---
title: UI5 Tutorials
permalink: walkthrough/build/29/README.html
---
...
**Next:** [Step 30: Routing and Navigation](../30/index.html "So far, we have put all app content on one single page. As we add more and more features, we want to split the content and put it on separate pages.")

**Previous:** [Step 28: Integration Test with OPA](../28/index.html "If we want to test interaction patterns or more visual features of our app, we can also write an integration test.")

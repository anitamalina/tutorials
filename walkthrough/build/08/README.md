---
title: UI5 Tutorials
permalink: walkthrough/build/08/README.html
---
...
**Next:** [Step 9: Component Configuration](../09/index.html "After we have introduced all three parts of the Model-View-Controller \(MVC\) concept, we now come to another important structural aspect of OpenUI5.")

**Previous:** [Step 7: JSON Model](../07/index.html "Now that we have set up the view and controller, it’s about time to think about the M in MVC.")

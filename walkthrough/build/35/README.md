---
title: UI5 Tutorials
permalink: walkthrough/build/35/README.html
---
...
**Previous:** [Step 34: Routing and Navigation](../34/index.html "We can now navigate between the overview and the detail page, but the actual item that we selected in the overview is not displayed on the detail page yet. A typical use case for our app is to show additional information for the selected item on the detail page.")
